	...
	public ReportExcelExport(Report report){
        ...
        for(TimeLog timeLog : tableView.getItems()) {
        	...
        	for (int j = 0; j < tableView.getColumns().size(); j++) {
        		...
        		switch(j) {
        		case 0 : cell.setCellValue(timeLog.getId());
        			break;
        		case 1 : cell.setCellValue(timeLog.getLogDate().format(DateTimeFormatter.ofPattern("yyyy/MM/dd")));
        			break;
        		case 2 : cell.setCellValue(timeLog.getContactName());
        			break;
        		case 3 : cell.setCellValue(timeLog.getTaskType());
        			break;
        		case 4 : cell.setCellValue(timeLog.getTaskDate().format(DateTimeFormatter.ofPattern("yyyy/MM/dd")));
 
        			break;
        		case 5 : cell.setCellValue(timeLog.getTaskName());
        			break;
        		case 6 : cell.setCellValue(timeLog.getTime());
        			cell.setCellStyle(daoubleStyle);
        			break;
        		case 7 : cell.setCellValue(timeLog.getTaskBody());
        			cell.setCellStyle(longTextStyle);
        			break;
        		case 8 : cell.setCellValue(timeLog.getMyComment());
        			cell.setCellStyle(longTextStyle);
        			break;
        		}
        	}
